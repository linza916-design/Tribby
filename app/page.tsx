  ...
  return (
    <div className="space-y-8">
      ...
      <div className="relative">
        <input
          className="w-full bg-black/40 border border-white/10 rounded-xl pl-10 py-3 text-sm text-white"
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="w-full mt-5 py-3 rounded-xl bg-green-400 text-black"
                >
